"""This module contains the prompts used for the main Naukri assistant."""
...
class NaukriPrompts(BasePrompts):
    """Naukri prompts."""
...
- ✅ Highlight action items or next steps when relevant.
            ...
            "summarize_naukri_process": dedent(
    ...
    prompts = DotMap(
        {
            **BasePrompts.prompts,
            "determine_student_intent": dedent(
                """Here is the conversation between the Naukri assistant and the student so far:
