...
from naukriwaala.graphs.utils import save_browser_state, save_graph_diagram
from naukriwaala.metrics.logfire_metrics import register_student_agent_hist
from naukriwaala.naukri.schemas import RegisterStudentQuery, RegisterStudentResults
from naukriwaala.naukri.utils import select_register_radio
...
async def register_student(
    *,
    ...
    naukri_query: RegisterStudentQuery,
    redis_client: aioredis.Redis,
    ...
    **The student's registration information will be automatically provided to me for
    ...
    naukri_query.user_id = f"Register_Student_Agent_Graph_{naukri_query.user_id}"
    ...
    chat_history, chat_params, session_id = await csm.init_chat_session(
        ...
        system_message=NaukriPrompts.system_messages["register_student_agent"],
    ...
    deps = RegisterStudentDeps(
        ...
        register_student_query=naukri_query,
    )
